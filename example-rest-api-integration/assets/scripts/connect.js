 ...
 * If the response is a successful connection,  it will close the opnened popup and reload the page.
 */
function startAuthorizationFlow(connectButton) {
  ...
  /**
   * This catches the case where the user closes the popup window
   */
