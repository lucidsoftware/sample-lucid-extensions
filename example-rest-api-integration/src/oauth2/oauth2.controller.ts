...
export class OAuth2Controller {
  ...
  /**
   * This method directs the user to the appropriate Lucid authorization URL as described in https://developer.lucid.co/rest-api/v1/#obtaining-an-access-token
