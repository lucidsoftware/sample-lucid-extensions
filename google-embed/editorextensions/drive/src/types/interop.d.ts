...
declare namespace i18n {
    ...
    // The supported languages in the extension https://developer.lucid.co/extension-api/#supported-languages
    type Locale = 'en' | 'de' | 'es-LA' | 'fr-FR' | 'ja' | 'nl' | 'pt-BR' | 'ru' | 'it-IT' | 'pl-PL' | 'sv-SE' | 'ko';
}
